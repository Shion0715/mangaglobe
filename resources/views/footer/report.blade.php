    ...
    <div class="container mx-auto my-6 px-4">
        ...
        <form method="POST" action="{{ route('report.store') }}" class="space-y-4">
            ...
            <div class="form-group my-7" id="manga_name" style="display: none;">
                ...
                <input type="text" class="form-control mt-1 block w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" id="manga_name_input" name="manga_name">
            </div>
            ...
            <div class="form-group my-7" id="comment_id_input" style="display: none;">
                ...
                <input type="text" class="form-control mt-1 block w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" id="comment_id" name="comment_id">
            </div>
