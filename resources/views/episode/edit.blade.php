    ...
    <x-slot name="header">
        <form method="post" action="{{route('episode.update', ['post' => $post->id, 'episode' => $episode->id])}}" enctype="multipart/form-data">
            ...
            <div style="display: flex; align-items: center;">
                ...
                <input type="number" id="episode_number" name="episode_number" value="{{$episode->number}}" min="1" onchange="showWarning()" style="width: 75px;">
        ...
        <div class="mx-4 sm:p-8">
            <div class="md:flex items-center mt-10">
                <div class="w-full flex flex-col mt-4">
                    ...
                    @enderror
                    <div class="flex mt-4">
                        <input type="text" name="ep_title" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="title" value="{{ old('ep_title', $episode->title) }}" placeholder="Enter Title">
                    </div>
                </div>
            </div>
            ...
            <div class="w-full flex flex-col mt-10">
                ...
                <div>
                    ...
                    <input type="hidden" name="old_ep_cover_image" value="{{ $episode->cover_image }}">
                </div>
                ...
                <div class="mt-4 max-w-[200px] max-h-auto overflow-hidden">
                    ...
                    <img id="original_ep_cover_image" src="{{ $episode->cover_image }}" alt="Cover Image" class="mt-3" style="height:auto; width: 200px;">
                    @endif
            ...
            <div class="w-full flex flex-col mt-10">
                ...
                <input type="file" name="images[]" id="images" multiple class="mt-4 form-control">
            ...
            <div class="w-full flex flex-col mt-10">
                ...
                <div class="flex mt-4">
                    <div class="flex items-center mr-4">
                        <input id="progress1" type="radio" value="continued" name="progress" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ old('progress', $episode->progress) == 'continued' ? 'checked' : '' }}>
                        <label for="progress1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Continued</label>
                    </div>
                    <div class="flex items-center mr-4">
                        <input id="progress2" type="radio" value="completed" name="progress" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ old('progress', $episode->progress) == 'completed' ? 'checked' : '' }}>
