            ...
            <form method="post" action="{{route('post.update',$post)}}" enctype="multipart/form-data">
                ...
                <div class="w-full flex flex-col mt-10">
                    ...
                    <div class="flex mt-4">
                        ...
                        <div class="flex items-center mr-4">
                            <input id="type2" type="radio" value="shojo" name="type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ old('type', $post->type) == 'shojo' ? 'checked' : '' }}>
                            <label for="type2" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Shojo</label>
                        </div>
                        <div class="flex items-center mr-4">
                            <input id="type3" type="radio" value="seinen" name="type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ old('type', $post->type) == 'seinen' ? 'checked' : '' }}>
                            <label for="type3" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Seinen</label>
                        </div>
                        <div class="flex items-center mr-4">
                            <input id="type4" type="radio" value="josei" name="type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ old('type', $post->type) == 'josei' ? 'checked' : '' }}>
                ...
                <div class="flex mt-4">
                    ...
                    <div class="flex items-center mr-4">
                        <input id="recieve_comment2" type="radio" value="no" name="recieve_comment" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ old('recieve_comment', $post->recieve_comment) == 'no' ? 'checked' : '' }}>
